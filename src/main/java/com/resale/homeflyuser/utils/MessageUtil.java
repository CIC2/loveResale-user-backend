...
public class MessageUtil {
    ...
    public String getLocalizedName(String nameEn, String nameAr, Locale locale) {
        return Locale.forLanguageTag("ar").getLanguage().equalsIgnoreCase(locale.getLanguage())
                ? nameAr
                : nameEn;
    }
